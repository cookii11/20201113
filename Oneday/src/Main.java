...
public class Main {
    public static void main(String[] args) {
        ...
        Meal hotelBuffet = new Meal(50000, 50);
            ...
            while (character.getNowTime() < 41) {
                ...
                switch (sc.nextInt()) {
                    case 1:
                        ...
                        int randomStress = (int) ((Math.random() * 50) + 1);
                ...
                if (character.checkEnding() == Character.ENDING_SUCCESS || character.checkEnding() == character.ENDING_PASAN
                        || character.checkEnding() == character.ENDING_DEAD) {
                    break;
                }
